...
class TestPyafmreader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # JPK files
        self.JPK_SINGLE_CURVE_FILE = loadfile(JPK_SINGLE_CURVE_PATH)
        self.JPK_FV_FILE = loadfile(JPK_FV_PATH)
        self.JPK_QI_FILE = None
        # self.JPK_THERMAL_DATA = loadfile(JPK_THERMAL_PATH)
        # NANOSCOPE files
    ...
    def test_load_NANOSC_single_curve_header(self):
        ...
        self.assertEqual(metadata.get('ramp_size_V', None), 227.2211)
    ...
    def test_load_NANOSC_FV_header(self):
        ...
        self.assertEqual(metadata.get('byte_per_pixel', None), 2)
        self.assertEqual(metadata.get('z_scale_Vbybyte', None), 0.0003750000)
        self.assertEqual(metadata.get('ramp_size_V', None), 151.4807)
    ...
    def test_load_NANOSC_PFC_header(self):
        ...
        self.assertEqual(metadata.get('byte_per_pixel', None), 2)
        self.assertEqual(metadata.get('z_scale_Vbybyte', None), 0.0003750000)
        self.assertEqual(metadata.get('ramp_size_V', None), 20)
